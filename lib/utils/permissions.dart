...
/// On macOS, permission_handler does not implement most permissions;
/// the underlying plugins (image_picker, record) handle them natively.
...
Future<bool> requestMicPermission(BuildContext context) => requestPermission(
  context,
